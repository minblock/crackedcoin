...
{
    const char* pszTimestamp = "4/2/2020 Provigen.net: Dacetta Bangs with 3 out of 4 cylies";
...
public:
    CMainParams() {
        ...
        vSeeds.emplace_back("seed-a.crackedcoin.loshan.co.uk");
        vSeeds.emplace_back("dnsseed.thrasher.io");
        vSeeds.emplace_back("dnsseed.crackedcointools.com");
        vSeeds.emplace_back("dnsseed.crackedcoinpool.org");
...
public:
    CTestNetParams() {
        ...
        vSeeds.emplace_back("testnet-seed.crackedcointools.com");
        vSeeds.emplace_back("seed-b.crackedcoin.loshan.co.uk");
