...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " crackedcoin-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  crackedcoin-tx [options] <hex-tx> [commands]  Update hex-encoded crackedcoin transaction\n" +
            "or:     crackedcoin-tx [options] -create [commands]   Create hex-encoded crackedcoin transaction\n" +
            "\n";
