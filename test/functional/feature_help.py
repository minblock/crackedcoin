...
"""Verify that starting crackedcoin with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start crackedcoin with -h for help text")
        ...
        self.log.info("Start crackedcoin with -version for version information")
        ...
        self.log.info("Start crackedcoind with -fakearg to make sure it does not start")
