Crackedcoin Core version *0.15.1* is now available from:

  <https://download.crackedcoin.org/crackedcoin-0.15.1/>
...
A number of changes to the way Crackedcoin Core deals with peer connections and invalid blocks
