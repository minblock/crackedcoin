# Support for Output Descriptors in Crackedcoin Core

Since Crackedcoin Core v0.17, there is support for Output Descriptors. This is a
...
on Crackedcoin's OP_CHECKMULTISIG opcode. To support these, we introduce the
...
existing Crackedcoin Core wallets, a convenience function `combo` is
